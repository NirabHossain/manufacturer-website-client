...
const Footer = () => {
    return (
        <footer style={{background:`ur(${footer})`, backgroundSize:'cover'}} className="footer footer-center p-10">
            <div>
                ...
                <p className="font-bold">
                    Nirab Tools and Suppliers Ltd. <br/>
                    The best supplier in the world and customizable with your choice
                </p>
                <p>© All right reserved - Nirab's company of tools and supplies</p>
            </div>
            <div>
